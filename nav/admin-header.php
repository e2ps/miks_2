                  ...
                  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse sticky-top">
                    <div class="position-sticky pt-3">
                      ...
                      <ul class="nav nav-pills flex-column mb-auto">
                        <li class="nav-item">
                          <a class="nav-link <?= ($this->subpage == 'Dashboard') ? 'active bg-gradient-primary' : 'text-white' ?>" href="admin.php?">
                            <i class="bi bi-speedometer2 me-2"></i> Dashboard
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link <?= ($this->subpage == 'home') ? 'active bg-gradient-primary' : 'text-white' ?>" href="admin_home.php?">
                      ...
                      <hr>
                        <?php 
                        foreach ($Seenprofile as $Seenprofile){
                      ?>                     
                       <!-- User dropdown -->
                      <div class="dropdown px-3">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                          <img src="<?= $Seenprofile['img'] ?>" alt="User Avatar" width="32" height="32" class="rounded-circle me-2">
                          <strong>mdo</strong>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                          <li><a class="dropdown-item" href="#">New project...</a></li>
                          <li><a class="dropdown-item" href="#">Settings</a></li>
                          <li><a class="dropdown-item <?= $this->subpage== 'PF' ? 'active bg-gradient-primary' : '' ?>" href="admin_PF.php">Profile</a></li>
